...
export interface ComparisionPagesComponentFeatureComparison
  extends Struct.ComponentSchema {
...
export interface ComparisionPagesComponentTestomial
  extends Struct.ComponentSchema {
...
export interface ElementsCustomerStoryItem extends Struct.ComponentSchema {
...
export interface ElementsResourceCardItem extends Struct.ComponentSchema {
  ...
  attributes: {
    badge: Schema.Attribute.Enumeration<['DOC', 'BLOG', 'VIDEO', 'WEBINAR']> &
      Schema.Attribute.Required;
    link: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface SectionCardsResourcesSection extends Struct.ComponentSchema {
  ...
  attributes: {
    ...
    heading: Schema.Attribute.Component<'elements.heading', false>;
    resourceCards: Schema.Attribute.Component<
      'elements.resource-card-item',
      true
    >;
...
export interface SectionTabsCustomerStories extends Struct.ComponentSchema {
  ...
  attributes: {
    background: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    customerStories: Schema.Attribute.Component<
      'elements.customer-story-item',
      true
    >;
    heading: Schema.Attribute.Component<'elements.heading', false>;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ComponentSchemas {
      ...
      'section-cards.resources-section': SectionCardsResourcesSection;
      ...
      'section-tabs.customer-stories': SectionTabsCustomerStories;
