...
export interface AbExperimentsComponentGoal extends Struct.ComponentSchema {
    ...
    attributes: {
        ...
        type: Schema.Attribute.Enumeration<["Element Click", "Form Submit", "Scroll Depth", "Time On Page"]>;
        value: Schema.Attribute.Integer;
    };
}

export interface AbExperimentsComponentTargetingRules extends Struct.ComponentSchema {
    ...
    attributes: {
        devices: Schema.Attribute.JSON & Schema.Attribute.Required & Schema.Attribute.CustomField<"plugin::multi-select.multi-select", ["Desktop:desktop", "Tablet:tablet", "Mobile:mobile", ""]> & Schema.Attribute.DefaultTo<"[]">;
...
export interface AbExperimentsComponentUrlRule extends Struct.ComponentSchema {
    ...
    attributes: {
        matchType: Schema.Attribute.Enumeration<["exact", "contains", "startsWith", "regex", "endsWith"]> & Schema.Attribute.Required;
...
export interface AbExperimentsComponentVariant extends Struct.ComponentSchema {
    ...
    attributes: {
        changes: Schema.Attribute.Component<"ab-experiments-component.variant-change", true>;
...
export interface AbExperimentsComponentVariantChange extends Struct.ComponentSchema {
    ...
    attributes: {
        ...
        type: Schema.Attribute.Enumeration<["text", "style", "image", "html"]> & Schema.Attribute.Required;
        value: Schema.Attribute.Text;
    };
}

export interface ComparisionPagesComponentDemoSection extends Struct.ComponentSchema {
...
export interface ComparisionPagesComponentFaqsSection extends Struct.ComponentSchema {
...
export interface ComparisionPagesComponentFeatureCards extends Struct.ComponentSchema {
...
export interface ComparisionPagesComponentFeatureComparison extends Struct.ComponentSchema {
    collectionName: "components_comparision_pages_component_feature_comparison_s";
    info: {
        description: "";
        displayName: "Feature Comparison ";
    };
    attributes: {
        comaparisonTableHead: Schema.Attribute.Component<"comparision-pages-component.feature-comparison-head", false>;
        comparisonRowsBody: Schema.Attribute.Component<"comparision-pages-component.feature-comparison-item", true>;
        heading: Schema.Attribute.Component<"elements.heading", false>;
    };
}

export interface ComparisionPagesComponentFeatureComparisonHead extends Struct.ComponentSchema {
...
export interface ComparisionPagesComponentFeatureComparisonItem extends Struct.ComponentSchema {
    collectionName: "components_comparision_pages_component_feature_comparison_items";
    info: {
        displayName: "Feature Comparison Item";
    };
    attributes: {
        competitorValue: Schema.Attribute.String;
        featureLabel: Schema.Attribute.String & Schema.Attribute.Required;
        openobserveValue: Schema.Attribute.String;
        referanceLinkText: Schema.Attribute.String;
        referanceUrl: Schema.Attribute.String;
    };
}

export interface ComparisionPagesComponentHerosection extends Struct.ComponentSchema {
    ...
    attributes: {
        ...
        stats: Schema.Attribute.Component<"elements.feature-title-description", true>;
...
export interface ComparisionPagesComponentLandingHerosection extends Struct.ComponentSchema {
...
export interface ComparisionPagesComponentLandingPageCtaBanner extends Struct.ComponentSchema {
    ...
    attributes: {
        items: Schema.Attribute.Component<"elements.feature-title-description", true>;
        primaryButton: Schema.Attribute.Component<"elements.button", false>;
        secondaryButton: Schema.Attribute.Component<"elements.button", false>;
...
export interface ComparisionPagesComponentMigrationSection extends Struct.ComponentSchema {
    ...
    attributes: {
        ...
        primaryButton: Schema.Attribute.Component<"elements.button", false>;
        secondaryButton: Schema.Attribute.Component<"elements.button", false>;
        testimonial: Schema.Attribute.Component<"comparision-pages-component.testomial", false>;
    };
}

export interface ComparisionPagesComponentSwitchFromOtherPlatforms extends Struct.ComponentSchema {
...
export interface ComparisionPagesComponentTestomial extends Struct.ComponentSchema {
    collectionName: "components_comparision_pages_component_testomials";
    info: {
        displayName: "testomial";
    };
    attributes: {
        image: Schema.Attribute.Media<"images" | "files" | "videos" | "audios">;
        name: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ComparisionPagesComponentVendorComparisonCards extends Struct.ComponentSchema {
...
export interface ComparisionPagesComponentWhyChooseO2 extends Struct.ComponentSchema {
...
export interface ElementsButton extends Struct.ComponentSchema {
    ...
    attributes: {
        ...
        theme: Schema.Attribute.Enumeration<["theme-blue", "theme-red", "theme-purple", "theme-green", "theme-outline", "theme-pricing-button", "theme-pricing-card"]>;
    };
}
...
export interface ElementsCaseStudyItem extends Struct.ComponentSchema {
    ...
    attributes: {
        clientLogo: Schema.Attribute.Media<"images" | "files" | "videos" | "audios"> & Schema.Attribute.Required;
        heading: Schema.Attribute.Component<"elements.heading", false>;
        image: Schema.Attribute.Media<"images" | "files" | "videos" | "audios">;
        items: Schema.Attribute.Component<"elements.feature-title-description", true>;
        link: Schema.Attribute.String;
...
export interface ElementsComparisonItem extends Struct.ComponentSchema {
    ...
    attributes: {
        badges: Schema.Attribute.Component<"elements.feature-title-description", true>;
        description: Schema.Attribute.Text;
        link: Schema.Attribute.String;
...
export interface ElementsEventCardItem extends Struct.ComponentSchema {
    ...
    attributes: {
        ...
        theme: Schema.Attribute.Enumeration<["theme-green-minimal", "theme-orange"]>;
        title: Schema.Attribute.String;
    };
}
...
export interface ElementsFeatureTitleDescription extends Struct.ComponentSchema {
...
export interface ElementsHomepageFeatureItem extends Struct.ComponentSchema {
    ...
    attributes: {
        ...
        heading: Schema.Attribute.Component<"elements.heading", false>;
        items: Schema.Attribute.Component<"elements.feature-title-description", true>;
        theme: Schema.Attribute.Enumeration<["theme-blue", "theme-red", "theme-purple", "theme-green", "theme-outline"]>;
    };
}
...
export interface ElementsOsSvsEnterpriseComparisonItem extends Struct.ComponentSchema {
...
export interface ElementsPricingItem extends Struct.ComponentSchema {
    ...
    attributes: {
        ...
        cardTheme: Schema.Attribute.Enumeration<["theme-blue", "theme-red", "theme-purple", "theme-green", "theme-outline", "theme-pricing-button", "theme-pricing-card"]>;
        description: Schema.Attribute.Text;
...
export interface ElementsSocialMediaIcon extends Struct.ComponentSchema {
    ...
    attributes: {
        link: Schema.Attribute.String & Schema.Attribute.Required;
        name: Schema.Attribute.Enumeration<["slack", "twitter", "github", "linkdin", "youtube"]> & Schema.Attribute.Required & Schema.Attribute.DefaultTo<"slack">;
    };
}
...
export interface LandingPageComponentAiCapabilitiesSection extends Struct.ComponentSchema {
...
export interface LandingPageComponentArchitectureSection extends Struct.ComponentSchema {
...
export interface LandingPageComponentEligibilityRequirements extends Struct.ComponentSchema {
...
export interface LandingPageComponentFeatureCards extends Struct.ComponentSchema {
...
export interface LandingPageComponentFeatureComparison extends Struct.ComponentSchema {
...
export interface LandingPageComponentHeroSection extends Struct.ComponentSchema {
    ...
    attributes: {
        comparisions: Schema.Attribute.Component<"elements.feature-title-description", true>;
        description: Schema.Attribute.Text;
...
export interface LandingPageComponentMigrationSteps extends Struct.ComponentSchema {
...
export interface LandingPageComponentModernFoundationCard extends Struct.ComponentSchema {
...
export interface LandingPageComponentPlatformOverview extends Struct.ComponentSchema {
...
export interface LandingPageComponentProblemSection extends Struct.ComponentSchema {
...
export interface LandingPageComponentSocialProofSection extends Struct.ComponentSchema {
...
export interface LandingPageComponentTermsAndConditions extends Struct.ComponentSchema {
...
export interface LandingPageComponentTestimonialSection extends Struct.ComponentSchema {
...
export interface LandingPageComponentTestimonial2 extends Struct.ComponentSchema {
...
export interface SectionCardsAdditionalResources extends Struct.ComponentSchema {
...
export interface SectionCardsClients extends Struct.ComponentSchema {
    ...
    attributes: {
        items: Schema.Attribute.Component<"elements.image", true> & Schema.Attribute.Required;
    };
}
...
export interface SectionCardsDatadogSwitchReasons extends Struct.ComponentSchema {
...
export interface SectionCardsFeature1 extends Struct.ComponentSchema {
    ...
    attributes: {
        ...
        ctaButton: Schema.Attribute.Component<"elements.button", false>;
        heading: Schema.Attribute.Component<"elements.heading", false>;
        headingLevel: Schema.Attribute.Enumeration<["H1", "H2", "H3", "H4", "H5", "H6"]>;
        items: Schema.Attribute.Component<"elements.items", true>;
    };
}
...
export interface SectionCardsModernFoundationCard extends Struct.ComponentSchema {
...
export interface SectionCardsTestimonialSection extends Struct.ComponentSchema {
    ...
    attributes: {
        authorImage: Schema.Attribute.Media<"images" | "files" | "videos" | "audios">;
...
export interface SectionCardsTestimonials extends Struct.ComponentSchema {
    ...
    attributes: {
        background: Schema.Attribute.Boolean;
        heading: Schema.Attribute.Component<"elements.heading", false>;
        items: Schema.Attribute.Component<"elements.testimonial-card", true> & Schema.Attribute.Required;
        primaryButton: Schema.Attribute.Component<"elements.button", false>;
    };
}
...
export interface SectionFaqsFrequentlyAskedQuestion extends Struct.ComponentSchema {
    ...
    attributes: {
        faqs: Schema.Attribute.Component<"elements.faq-item", true> & Schema.Attribute.Required;
        heading: Schema.Attribute.Component<"elements.heading", false>;
    };
}
...
export interface SectionFeaturesCloudSectionForDownloads extends Struct.ComponentSchema {
    ...
    attributes: {
        description: Schema.Attribute.Text;
        items: Schema.Attribute.Component<"elements.feature-title-description", true> & Schema.Attribute.Required;
        primaryButton: Schema.Attribute.Component<"elements.button-with-icon", false>;
        title: Schema.Attribute.String & Schema.Attribute.Required;
    };
}

export interface SectionFeaturesDownloadDeploymentOption extends Struct.ComponentSchema {
    ...
    attributes: {
        ...
        haDeploymentPrimaryButton: Schema.Attribute.Component<"elements.button", false>;
...
export interface SectionFeaturesFeatureComparison extends Struct.ComponentSchema {
...
export interface SectionFeaturesFeatureList extends Struct.ComponentSchema {
    ...
    attributes: {
        items: Schema.Attribute.Component<"elements.feature-item", true> & Schema.Attribute.Required;
    };
}

export interface SectionFeaturesFeatureSubPageTopTabs extends Struct.ComponentSchema {
...
export interface SectionFeaturesHomeMarketectureSection extends Struct.ComponentSchema {
...
export interface SectionFeaturesPlatformFeaturesTopTabs extends Struct.ComponentSchema {
...
export interface SectionFeaturesSelfHostedForDownloads extends Struct.ComponentSchema {
    ...
    attributes: {
        ...
        enterpriseFeatures: Schema.Attribute.Component<"elements.feature-title-description", true>;
...
export interface SectionFeaturesTabsFeatures extends Struct.ComponentSchema {
    ...
    attributes: {
        background: Schema.Attribute.Boolean;
        heading: Schema.Attribute.Component<"elements.heading", false> & Schema.Attribute.Required;
        items: Schema.Attribute.Component<"elements.feature-item", true> & Schema.Attribute.Required;
    };
}
...
export interface SectionFeaturesTechnologies extends Struct.ComponentSchema {
    ...
    attributes: {
        features: Schema.Attribute.Component<"elements.items", true>;
        heading: Schema.Attribute.Component<"elements.heading", false>;
        techFeatures: Schema.Attribute.Component<"elements.technologies-features", true>;
...
export interface SectionFormsDownloadContactForm extends Struct.ComponentSchema {
...
export interface SectionHeroAiNativePageHerosection extends Struct.ComponentSchema {
...
export interface SectionHeroDatadogHeroSection extends Struct.ComponentSchema {
    ...
    attributes: {
        datadogNote: Schema.Attribute.String & Schema.Attribute.DefaultTo<"+ $0.05/custom metric + $1.70/million spans">;
        datadogPricing: Schema.Attribute.String & Schema.Attribute.DefaultTo<"$15-27/host/month">;
        ...
        openobserveNote: Schema.Attribute.String & Schema.Attribute.DefaultTo<"Unlimited custom metrics included">;
        openobservePricing: Schema.Attribute.String & Schema.Attribute.DefaultTo<"$0/host">;
        subtitle: Schema.Attribute.Text & Schema.Attribute.Required;
        title: Schema.Attribute.String & Schema.Attribute.Required;
        trustLabel: Schema.Attribute.String & Schema.Attribute.DefaultTo<"Teams that made the switch">;
...
export interface SectionHeroHomepageHero extends Struct.ComponentSchema {
    ...
    attributes: {
        ...
        description: Schema.Attribute.Text;
        primaryButton: Schema.Attribute.Component<"elements.button", false> & Schema.Attribute.Required;
        secondaryButton: Schema.Attribute.Component<"elements.button", false>;
        title: Schema.Attribute.String & Schema.Attribute.Required;
        trustedCompanies: Schema.Attribute.Component<"elements.image", true>;
...
export interface SectionHeroResourceHeroSection extends Struct.ComponentSchema {
    ...
    attributes: {
        align: Schema.Attribute.Enumeration<["LEFT", "CENTER", "RIGHT"]> & Schema.Attribute.DefaultTo<"LEFT">;
        description: Schema.Attribute.Text;
        primaryButton: Schema.Attribute.Component<"elements.button", false>;
        title: Schema.Attribute.String & Schema.Attribute.Required;
    };
...
export interface SectionHeroSolutionSubpageHerosection extends Struct.ComponentSchema {
    ...
    attributes: {
        bgImageForLaptop: Schema.Attribute.Media<"images" | "files" | "videos" | "audios">;
        bgImageForMobile: Schema.Attribute.Media<"images" | "files" | "videos" | "audios">;
        description: Schema.Attribute.Text;
        Image: Schema.Attribute.Media<"images" | "files" | "videos" | "audios">;
        primaryButton: Schema.Attribute.Component<"elements.button", false>;
        secondaryButton: Schema.Attribute.Component<"elements.button", false>;
...
export interface SectionHeroSolutionsHeroSection extends Struct.ComponentSchema {
...
export interface SectionJsonStructureForGoogleBotJsonLdSchema extends Struct.ComponentSchema {
    ...
    attributes: {
        ...
        schemaType: Schema.Attribute.Enumeration<["WebPage", "Article", "BlogPosting", "TechArticle", "SoftwareApplication", "Product", "FAQPage", "BreadcrumbList", "Event", "Organization"]> &
            Schema.Attribute.Required &
...
export interface SectionTabsDownloadTabs extends Struct.ComponentSchema {
    ...
    attributes: {
        cloudData: Schema.Attribute.Component<"section-features.cloud-section-for-downloads", false>;
        heading: Schema.Attribute.Component<"elements.heading", false>;
        selfHostedData: Schema.Attribute.Component<"section-features.self-hosted-for-downloads", false>;
    };
}
...
export interface SeoSeo extends Struct.ComponentSchema {
    ...
    attributes: {
        ...
        structuredSchema: Schema.Attribute.Component<"section-json-structure-for-google-bot.json-ld-schema", false>;
        title: Schema.Attribute.String;
