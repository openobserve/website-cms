...
export interface ApiGithubReleaseGithubRelease
  ...
  attributes: {
    ...
    isLatest: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    shaKeyForLinux: Schema.Attribute.String;
    shaKeyForMac: Schema.Attribute.String;
    shaKeyForWindows: Schema.Attribute.String;
...
export interface ApiPlatformPagePlatformPage
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    isPreviewPage: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
